    ...
    <table class="all">
        ...
        <tr>
            ...
            <td class="pp">
                ...
                <div>
                    <input type="checkbox" name="pr[]" value="2" <?=(in_array(2, $userPr))?"checked":'';?>>訂單選項
                </div>
                <div>
                ...
                <div>
                    <input type="checkbox" name="pr[]" value="5" <?=(in_array(5, $userPr))?"checked":'';?>>最新消息管理
                </div>
